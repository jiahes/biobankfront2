    ...
    <div id="toolbar" style="">
          <div style="width: 250px;margin: 0 5px 0 5px;" class="pull-left">
            ...
            <input type="text" class="" style="height: 30px;width:75px;" @click="openByDrop4($event)" v-model="calendar4.display" readonly>
             ...
             关键字：<input type="text" class="" style="height: 30px;width:75px; pull-left">检索
           <button class="btn btn-success addDisease btn-sm pull-left">新增角色(A)</button>
           <button class="btn btn-success addDisease btn-sm pull-left">导出excel(E)</button>
    </div>
