<template>
  <div class="register">
    <div id="toolbar" style="">
           ...
           <button class="btn btn-success addDisease btn-sm">新增角色(A)</button>
...
var TableInit = function () {
    ...
    oTableInit.operateFormatter = function(value, row, index) {
        return [
            ...
            '<button class="btn btn-primary btn-xs role ">角色</button>',
            '<button class="btn btn-primary btn-xs delete ">删除</button>',
